...
public class Item_________ {

    @JsonProperty("ClassJobCategory")
    private ClassJobCategory____________ classJobCategory;
    @JsonProperty("ID")
    private Integer iD;
    @JsonProperty("Icon")
    private String icon;
    @JsonProperty("ItemUICategory")
    private ItemUICategory_________ itemUICategory;
    ...
    @JsonProperty("ClassJobCategory")
    public ClassJobCategory____________ getClassJobCategory() {
        return classJobCategory;
    }

    @JsonProperty("ClassJobCategory")
    public void setClassJobCategory(ClassJobCategory____________ classJobCategory) {
    ...
    @JsonProperty("ItemUICategory")
    public ItemUICategory_________ getItemUICategory() {
        return itemUICategory;
    }

    @JsonProperty("ItemUICategory")
    public void setItemUICategory(ItemUICategory_________ itemUICategory) {
