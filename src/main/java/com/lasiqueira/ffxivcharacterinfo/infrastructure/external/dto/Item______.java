...
public class Item______ {
    ...
    private ClassJobCategory_________ classJobCategory;
    @JsonProperty("ID")
    private Integer iD;
    @JsonProperty("Icon")
    private String icon;
    @JsonProperty("ItemUICategory")
    private ItemUICategory______ itemUICategory;
    ...
    @JsonProperty("ClassJobCategory")
    public ClassJobCategory_________ getClassJobCategory() {
        return classJobCategory;
    }

    @JsonProperty("ClassJobCategory")
    public void setClassJobCategory(ClassJobCategory_________ classJobCategory) {
    ...
    @JsonProperty("ItemUICategory")
    public ItemUICategory______ getItemUICategory() {
        return itemUICategory;
    }

    @JsonProperty("ItemUICategory")
    public void setItemUICategory(ItemUICategory______ itemUICategory) {
