...
public class Job_ {
    ...
    private ClassJobCategory__ classJobCategory;
    @JsonProperty("ID")
    private Integer iD;
    @JsonProperty("Icon")
    private String icon;
    ...
    @JsonProperty("ClassJobCategory")
    public ClassJobCategory__ getClassJobCategory() {
        return classJobCategory;
    }

    @JsonProperty("ClassJobCategory")
    public void setClassJobCategory(ClassJobCategory__ classJobCategory) {
