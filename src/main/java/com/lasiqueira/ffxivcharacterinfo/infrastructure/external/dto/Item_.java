...
public class Item_ {
    ...
    private ClassJobCategory____ classJobCategory;
    @JsonProperty("ID")
    private Integer iD;
    @JsonProperty("Icon")
    private String icon;
    @JsonProperty("ItemUICategory")
    private ItemUICategory_ itemUICategory;
    ...
    @JsonProperty("ClassJobCategory")
    public ClassJobCategory____ getClassJobCategory() {
        return classJobCategory;
    }

    @JsonProperty("ClassJobCategory")
    public void setClassJobCategory(ClassJobCategory____ classJobCategory) {
    ...
    @JsonProperty("ItemUICategory")
    public ItemUICategory_ getItemUICategory() {
        return itemUICategory;
    }

    @JsonProperty("ItemUICategory")
    public void setItemUICategory(ItemUICategory_ itemUICategory) {
