...
public class Item_______ {
    ...
    private ClassJobCategory__________ classJobCategory;
    @JsonProperty("ID")
    private Integer iD;
    @JsonProperty("Icon")
    private String icon;
    @JsonProperty("ItemUICategory")
    private ItemUICategory_______ itemUICategory;
    ...
    @JsonProperty("ClassJobCategory")
    public ClassJobCategory__________ getClassJobCategory() {
        return classJobCategory;
    }

    @JsonProperty("ClassJobCategory")
    public void setClassJobCategory(ClassJobCategory__________ classJobCategory) {
    ...
    @JsonProperty("ItemUICategory")
    public ItemUICategory_______ getItemUICategory() {
        return itemUICategory;
    }

    @JsonProperty("ItemUICategory")
    public void setItemUICategory(ItemUICategory_______ itemUICategory) {
