...
public class Item____________ {

    @JsonProperty("ClassJobCategory")
    private ClassJobCategory_______________ classJobCategory;
    @JsonProperty("ID")
    private Integer iD;
    @JsonProperty("Icon")
    private String icon;
    @JsonProperty("ItemUICategory")
    private ItemUICategory____________ itemUICategory;
    ...
    @JsonProperty("ClassJobCategory")
    public ClassJobCategory_______________ getClassJobCategory() {
        return classJobCategory;
    }

    @JsonProperty("ClassJobCategory")
    public void setClassJobCategory(ClassJobCategory_______________ classJobCategory) {
    ...
    @JsonProperty("ItemUICategory")
    public ItemUICategory____________ getItemUICategory() {
        return itemUICategory;
    }

    @JsonProperty("ItemUICategory")
    public void setItemUICategory(ItemUICategory____________ itemUICategory) {
