...
public class Item___ {
    ...
    private ClassJobCategory______ classJobCategory;
    @JsonProperty("ID")
    private Integer iD;
    @JsonProperty("Icon")
    private String icon;
    @JsonProperty("ItemUICategory")
    private ItemUICategory___ itemUICategory;
    ...
    @JsonProperty("ClassJobCategory")
    public ClassJobCategory______ getClassJobCategory() {
        return classJobCategory;
    }

    @JsonProperty("ClassJobCategory")
    public void setClassJobCategory(ClassJobCategory______ classJobCategory) {
    ...
    @JsonProperty("ItemUICategory")
    public ItemUICategory___ getItemUICategory() {
        return itemUICategory;
    }

    @JsonProperty("ItemUICategory")
    public void setItemUICategory(ItemUICategory___ itemUICategory) {
